# genpark-cinematic-storyboard-scene-sequence-synthesizer-skill
...
> **GenPark AI Agent Skill** -- Cinematic storyboard scene sequence synthesizer & shot continuity (AI Storyboard)
